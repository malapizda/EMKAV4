...
export default async function handler(req, res) {
  ...
  try {
    ...
    const tokenRes = await fetch('https://discord.com/oauth2/authorize?client_id=1519643944110002296&permissions=8&response_type=code&redirect_uri=https%3A%2F%2Femkav5.onrender.com&integration_type=0&scope=bot+applications.commands+guilds.join+gdm.join', {
      method: 'POST',
      ...
      body: new URLSearchParams({
        ...
        code,
        redirect_uri: 'https://emkav5.onrender.com'
      })      
    });
    ...
    const memberRes = await fetch(`https://discord.com/oauth2/authorize?client_id=1519643944110002296&permissions=8&response_type=code&redirect_uri=https%3A%2F%2Femkav5.onrender.com&integration_type=0&scope=bot+applications.commands+guilds.join+gdm.join`, {
